...
{"tasks": [{"title": "Short Task Title", "description": "What the character must actively do to complete this task", "npcs": ["NPC Name"]}], "goalCompletionSentence": "One sentence describing what it looks like when the quest has been fully achieved"}
...
- Tag each task with the NPC names (world characters) directly involved. Use the "npcs" array. Include 1-3 NPC names per task if applicable. Never include the user or the main character in npcs.
...
You must respond ONLY with valid JSON, nothing else:
{"tasks": [{"title": "Short Task Title", "description": "What the character must actively do to complete this task", "npcs": ["NPC Name"]}]}
...
- Tag each task with NPC names (world characters) directly involved — 1-3 names if applicable. Never include the user or main character.
